...
/* This file contains CAPFS library call for fchmod.  		*/
...
int capfs_fchmod(int fd, mode_t mode)
{
	...
	request.req.fchmod.file_ino = pfds[fd]->fd.meta.u_stat.st_ino;
	request.req.fchmod.fs_ino = pfds[fd]->fd.meta.fs_ino;

...
int capfs_vfs_stats_get_info( char * buffer, char ** start, off_t offset, int length);
...
int capfs_capfsd_stats_get_info(char *buffer, char **start, off_t offset, int length);
